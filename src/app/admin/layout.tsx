...
import { BadgePercent, LayoutDashboard, LayoutTemplate, MessageSquareQuote, Package, RefreshCcw, Settings, ShoppingBag, Truck } from "lucide-react";
...
const navigation = [
  ...
  { href: "/admin/home-productos", label: "Home productos", icon: <LayoutTemplate className="h-4 w-4" /> },
  { href: "/admin/configuracion", label: "Configuracion", icon: <Settings className="h-4 w-4" /> },
  { href: "/admin/cupones", label: "Cupones", icon: <BadgePercent className="h-4 w-4" /> },
  { href: "/admin/testimonios", label: "Testimonios", icon: <MessageSquareQuote className="h-4 w-4" /> },
