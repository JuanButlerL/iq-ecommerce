        ...
        {success ? (
          <div className="px-8 py-10 text-center sm:px-10 sm:py-10">
            ...
            <div className="mt-[22px] flex justify-center">
              ...
              >
                {welcomePopupCopy.successPrimaryAction} →
              </Link>
            </div>
          </div>
        ) : (
          <div className="px-[22px] pb-5 pt-6 sm:px-10 sm:pb-8 sm:pt-10">
            ...
            <p className="hidden text-center text-[13px] leading-[1.65] text-[#9a8a7a] sm:block">
              {welcomePopupCopy.supportingText}
            </p>
            ...
            >
              {submitting ? "Enviando..." : `${welcomePopupCopy.submitLabel} →`}
            </button>
